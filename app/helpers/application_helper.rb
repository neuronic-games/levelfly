...
module ApplicationHelper
  ...
  def is_profile_accessible?(profile)
    access = true
    current_user_profile = current_user.instance_of?(User) ? current_user.profiles.first : current_user
  ...
  def student?
    current_user_profile = current_user.instance_of?(User) ? current_user.profiles.first : current_user
    current_user_profile.role_name_id == 1
  end
