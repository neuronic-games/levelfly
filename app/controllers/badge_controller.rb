class BadgeController < ApplicationController
  ...
  def new_badges
    # @badges = Badge.create
    @badge_image = BadgeImage.where.not(image_file_name: 'gold_badge.png')
    course_ids = Course.where([
                                "participants.profile_id = ? and participants.profile_type = 'M' and participants.target_type = 'Course' and parent_type = 'C' and removed = ?",
  ...
  def save
    return unless params[:badge_image_id] && !params[:badge_image_id].nil?
  ...
  def give_badge_to_student
    return unless params[:badge_id] && !params[:badge_id].nil? # && (params[:course_id] && !params[:course_id].nil?)
  ...
  def warning_box
    return unless params[:badge_id] && !params[:badge_id].nil?
