class WardrobeItem < ActiveRecord::Base
  ...
  def self.AddItem(wardrobe_name, level_0_name, level_1_name, name, item_type, image_file)
    ...
    level_0 = WardrobeItem.find(:first, :conditions => ["name = ? and parent_item is null and depth = 0", level_0_name])
