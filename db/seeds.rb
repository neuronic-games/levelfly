...
Major.create(:school_id => school, :name =>"Allied health", :code => "ALL")
Major.create(:school_id => school, :name =>"Art", :code => "ART")
Major.create(:school_id => school, :name =>"Business managment", :code => "BSM")
Major.create(:school_id => school, :name =>"Center for studies", :code => "CFS")
Major.create(:school_id => school, :name =>"Computer", :code => "COM")
Major.create(:school_id => school, :name =>"Cooprative education", :code => "CEU")
Major.create(:school_id => school, :name =>"Developmental skills", :code => "DVS")
Major.create(:school_id => school, :name =>"English", :code => "ENG")
Major.create(:school_id => school, :name =>"Health education", :code => "HEU")
Major.create(:school_id => school, :name =>"Language", :code => "LAN")
Major.create(:school_id => school, :name =>"Mathematics", :code => "MTH")
Major.create(:school_id => school, :name =>"Media art", :code => "MAR")
Major.create(:school_id => school, :name =>"Nursing", :code => "NUR")
Major.create(:school_id => school, :name =>"Science", :code => "SCI")
Major.create(:school_id => school, :name =>"Social science", :code => "SSC")
Major.create(:school_id => school, :name =>"Teacher education", :code => "TEU")
Major.create(:school_id => school, :name =>"Theatre art", :code => "THA")
