...
default_profile = Profile.create(:code => 'DEFAULT', :school => school, :image_file_name => Profile.default_avatar_image)
...
item['props_jewelery'] = WardrobeItem.create(:wardrobe => basic, :parent_item => item['props'], :name => 'Jewelry', :item_type => 'jewlery', :sort_order => 0, :depth => 1)
...
# Jewlery
WardrobeItem.create(:wardrobe => basic, :parent_item => item['props_jewelery'], :name => 'Orange Necklace', :item_type => 'necklace', :image_file => 'basic/necklace/necklace_orange', :sort_order => 0, :depth => 2)
WardrobeItem.create(:wardrobe => basic, :parent_item => item['props_jewelery'], :name => 'Orange Earrings', :item_type => 'earrings', :image_file => 'basic/earrings/earring_orange', :sort_order => 1, :depth => 2)
