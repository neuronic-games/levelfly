...
ActiveRecord::Schema[7.1].define(version: 20_250_926_032_309) do
  ...
  create_table 'checkpoints', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil
    t.datetime 'updated_at', precision: nil
    t.index %w[profile_id game_id], name: 'index_checkpoints_on_profile_id_and_game_id'
  end
  ...
  create_table 'course_grades', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: nil
    t.string 'notes'
    t.index %w[profile_id course_id outcome_id],
            name: 'index_course_grades_on_profile_id_and_course_id_and_outcome_id'
  end
  ...
  create_table 'courses_outcomes', id: false, force: :cascade do |t|
    t.integer 'course_id'
    t.integer 'outcome_id'
    t.index %w[course_id outcome_id], name: 'index_courses_outcomes_on_course_id_and_outcome_id'
  end
  ...
  create_table 'feats', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil
    t.datetime 'updated_at', precision: nil
    t.index %w[profile_id game_id], name: 'index_feats_on_profile_id_and_game_id'
  end
  ...
  create_table 'game_schools', id: :serial, force: :cascade do |t|
    ...
    t.index %w[game_id school_id], name: 'index_game_schools_on_game_id_and_school_id'
  end
  ...
  create_table 'game_score_leaders', id: :serial, force: :cascade do |t|
    ...
    t.string 'full_name'
    t.integer 'score'
    t.index %w[profile_id game_id], name: 'index_game_score_leaders_on_profile_id_and_game_id'
  end
  ...
  create_table 'games', id: :serial, force: :cascade do |t|
    ...
    t.string 'mail_to'
    t.integer 'course_id'
    t.index %w[archived published handle], name: 'index_games_on_archived_and_published_and_handle'
    t.index %w[archived published name], name: 'index_games_on_archived_and_published_and_name'
  end

  create_table 'games_outcomes', id: false, force: :cascade do |t|
    t.integer 'game_id'
    t.integer 'outcome_id'
    t.index %w[game_id outcome_id], name: 'index_games_outcomes_on_game_id_and_outcome_id'
  end
  ...
  create_table 'message_viewers', id: :serial, force: :cascade do |t|
    ...
    t.index %w[poster_profile_id viewer_profile_id], name: 'index_message_viewers_on_poster_and_viewer'
  end
  ...
  create_table 'messages', id: :serial, force: :cascade do |t|
    ...
    t.string 'topic'
    t.boolean 'starred', default: false
    t.index "to_tsvector('english'::regconfig, lower((topic)::text))", name: 'index_messages_on_lower_topic',
                                                                       using: :gin
    t.index "to_tsvector('english'::regconfig, lower(content))", name: 'index_messages_on_lower_content', using: :gin
    t.index %w[profile_id parent_id], name: 'index_messages_on_profile_id_and_parent_id'
  end
  ...
  create_table 'outcome_feats', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil
    t.datetime 'updated_at', precision: nil
    t.index %w[profile_id outcome_id feat_id],
            name: 'index_outcome_feats_on_profile_id_and_outcome_id_and_feat_id'
  end
  ...
  create_table 'profiles', id: :serial, force: :cascade do |t|
    ...
    t.index "to_tsvector('english'::regconfig, lower((full_name)::text))", name: 'index_profiles_on_lower_full_name',
                                                                           using: :gin
  end
